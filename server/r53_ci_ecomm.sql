...
(10, '2023-06-15-121007', 'App\\Database\\Migrations\\Profile', 'default', 'App', 1686832165, 4);
...
INSERT INTO `profiles` (`id`, `user_id`, `first_name`, `middle_name`, `last_name`, `avatar`, `phone`, `in`, `fb`, `tw`, `created_at`) VALUES
(1, 1, 'test', 't', 'user', 'avatar/testuser.jpg', '435746y7', 'asdfgdfsg', 'dasfgdfsg', 'agdfg', '2023-06-15 12:47:33');
...
(1, 'testuser', 'user@gmail.com', '$2y$10$yyxO2S55jQsfNSGKk06fS.j2.8l2H0GjhWgFhADoYJYDekkFHfg5m', 1, NULL, '2023-06-08 11:36:08'),
